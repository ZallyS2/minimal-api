...
//cadastrar 
app.MapPost("/admins", ([FromBody] AdministradorDTO loginDTO, IAdministradorService administradorService) => {
...
app.MapGet("/admins", ([FromQuery] int? page, IAdministradorService administradorService) => {
